    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded bg-dark border-gray-300 dark:border-gray-700 text-blue-500 shadow-sm focus:ring-blue-500 dark:focus:ring-blue-500 dark:focus:ring-offset-gray-800" name="remember">
